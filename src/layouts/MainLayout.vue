...
<header v-if="!uiHydrated" class="q-header q-layout__section--marginal fixed-top"><div class="container"><div class="q-toolbar row no-wrap items-center flex justify-between q-pa-sm" role="toolbar"><div class="flex"><!-- Desktop Navigation --><!--v-if--><!-- Mobile Menu Toggle --><button class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" type="button" aria-label="Open menu" fdprocessedid="ic1b69"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M0 0h24v24H0z" style="fill: none;"></path><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg></i></span></button></div><a aria-current="page" href="/" class="router-link-active router-link-exact-active flex items-center q-mr-auto order-first" aria-label="Navigate to home page"><svg width="180px" height="42px" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 206.73 48" style="display: block;"><text transform="translate(55 23.71)" style="fill: var(--q-secondary); font-family: ArialMT, Arial; font-size: 26px; isolation: isolate;"><tspan x="0" y="0">NaturaBloom</tspan></text><text transform="translate(56 41.71)" style="fill: var(--q-secondary); font-family: ArialMT, Arial; font-size: 12px; isolation: isolate;"><tspan x="0" y="0">Let</tspan><tspan x="16.68" y="0" style="letter-spacing: -0.02em;">’</tspan><tspan x="19.13" y="0">s Bloom</tspan><tspan x="62.48" y="0" style="letter-spacing: -0.02em;"></tspan><tspan x="65.6" y="0" style="letter-spacing: -0.11em;">T</tspan><tspan x="71.6" y="0">ogether</tspan></text><circle cx="24" cy="24" r="24" style="fill: rgb(243, 236, 226);"></circle><path d="M24,10c6,10,6,18,0,28-6-10-6-18,0-28Z" style="fill: rgb(163, 201, 168);"></path></svg></a><div><button class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense q-ml-sm q-mr-sm" tabindex="0" type="button" aria-label="Add to wishlist" fdprocessedid="rfe28b"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M0 0h24v24H0z" style="fill: none;"></path><path d="M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z"></path></svg></i><div class="q-badge flex inline items-center no-wrap q-badge--single-line bg-red q-badge--floating" role="status">1</div></span></button><button class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" type="button" aria-label="View cart" fdprocessedid="cywulm"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M0 0h24v24H0z" style="fill: none;"></path><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"></path></svg></i><!--v-if--></span></button></div></div></div><div class="q-layout__shadow absolute-full overflow-hidden no-pointer-events"></div><!----></header>
...
const QBtn = defineAsyncComponent(() => import('quasar').then(m => m.QBtn))
const QBadge = defineAsyncComponent(() => import('quasar').then(m => m.QBadge))
const QIcon = defineAsyncComponent(() => import('quasar').then(m => m.QIcon))
const QToolbarTitle = defineAsyncComponent(() => import('quasar').then(m => m.QToolbarTitle))
