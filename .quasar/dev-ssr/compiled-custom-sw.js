...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  registerRoute(
    ({ url }) => url.origin === "https://nuxt.meidanm.com" && url.pathname === "/wp-json/wc/store/v1/products" && url.searchParams.has("per_page"),
    new NetworkFirst({
